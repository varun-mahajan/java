...
//        doUnaryCall(secureChannel);
    ...
    private void doUnaryCall(ManagedChannel channel) {
      ...
      Context.keyWithDefault("varun", "mahajan");
    ...
    private void doServerStreamingCall(ManagedChannel channel) {
        ...
        System.out.println(" *** Making Server streaming call *** ");
        // Server Streaming
    ...
    private void doClientStreamingCall(ManagedChannel channel) {
        ...
        System.out.println(" *** Making Client streaming call *** ");
    ...
    private void doBiDiStreamingCall(ManagedChannel channel) {
        GreetServiceGrpc.GreetServiceStub asyncClient = GreetServiceGrpc.newStub(channel);
        System.out.println(" *** Making Bidi streaming call *** ");
        CountDownLatch latch = new CountDownLatch(1);
